            ...
            <form method='POST' action='/?page=output2'>
                ...
                <div class='form-group'>
                    <div class='form-row mb-2'>
                        ...
                        <div class='col'>
                            <input type='text' class='form-control' id='ShiftPattern' placeholder='C' name='Shift2'
                                value='C' required>
                        </div>
                        <div class='col'>
                            <input type='text' class='form-control' id='ShiftPattern' placeholder='A' name='Shift3'
                                value='A' required>
                        </div>
                        <div class='col'>
                            <input type='text' class='form-control' id='ShiftPattern' placeholder='B' name='Shift4'
                                value='B' required>
                        </div>
                        <div class='col'>
                            <input type='text' class='form-control' id='ShiftPattern' placeholder='D' name='Shift5'
                                value='D' required>
                        </div>
                        <div class='col'>
                            <input type='text' class='form-control' id='ShiftPattern' placeholder='B' name='Shift6'
                                value='B' required>
                        </div>
                        <div class='col'>
                            <input type='text' class='form-control' id='ShiftPattern' placeholder='D' name='Shift7'
                                value='D' required>
                        </div>
                        <div class='col'>
                            <input type='text' class='form-control' id='ShiftPattern' placeholder='A' name='Shift8'
                                value='A' required>
                        </div>
                    </div>
                    <div class='form-row'>
                        <div class='col'>
                            <input type='text' class='form-control' id='ShiftPattern' placeholder='C' name='Shift9'
                                value='C' required>
                        </div>
                        <div class='col'>
                            <input type='text' class='form-control' id='ShiftPattern' placeholder='A' name='Shift10'
                                value='A' required>
                        </div>
                        <div class='col'>
                            <input type='text' class='form-control' id='ShiftPattern' placeholder='C' name='Shift11'
                                value='C' required>
                        </div>
                        <div class='col'>
                            <input type='text' class='form-control' id='ShiftPattern' placeholder='D' name='Shift12'
                                value='D' required>
                        </div>
                        <div class='col'>
                            <input type='text' class='form-control' id='ShiftPattern' placeholder='B' name='Shift13'
                                value='B' required>
                        </div>
                        <div class='col'>
                            <input type='text' class='form-control' id='ShiftPattern' placeholder='D' name='Shift14'
                                value='D' required>
                        </div>
                        <div class='col'>
                            <input type='text' class='form-control' id='ShiftPattern' placeholder='B' name='Shift15'
                                value='B' required>
                        </div>
                        <div class='col'>
                            <input type='text' class='form-control' id='ShiftPattern' placeholder='C' name='Shift16'
                                value='C' required>
                        </div>
                    </div>
                </div>
